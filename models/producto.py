...
class Producto(Base):
    ...
    fecha_hasta = Column(Date, nullable=True)               # Fin de vigencia (puede ser null si sigue vigente)

    id_tipo_producto = Column(Integer, ForeignKey("tipos_producto.id"), nullable=False)  # FK a tabla tipo de producto
